const TRANSLATIONS = {
  ...
  en: {
    ...
    diffMedium:         'Medium',
    diffHard:           'Hard',
    enableRenju:        'Enable forbidden moves (Renju)',
  ...
  ms: {
    ...
    diffHard:           'Susah',
    enableRenju:        'Aktifkan peraturan terlarang',
    aiThinking:         'Komputer sedang berfikir…',
    undoMove:           'Undo',
    boardTheme:         'Gaya Papan',
    themeWood:          'Kayu Klasik',
    themeRosewood:      'Kayu Mawar',
    themeSlate:         'Batu Tulis',
    themeNight:         'Malam',
    themeBamboo:        'Buluh',
  },
  vi: {
