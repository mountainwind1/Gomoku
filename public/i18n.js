const TRANSLATIONS = {
  ...
  en: {
    ...
    initialStatus:      'Choose a game mode to start',
    connected:          'Connected',
  ...
  ms: {
    ...
    initialStatus:      'Pilih mod permainan untuk bermula',
    connected:          'Disambung',
    ...
    diffHard:           'Susah',
    aiThinking:         'Komputer sedang berfikir…',
    undoMove:           'Undo',
  },
  vi: {
    title:              'Cờ Gomoku',
    findGame:           'Tìm Trận',
    playAgain:          'Chơi Lại',
    initialStatus:      'Chọn chế độ chơi để bắt đầu',
    ...
    diffMedium:         'Vừa',
    diffHard:           'Khó',
    aiThinking:         'Máy tính đang suy nghĩ…',
    undoMove:           'Hối',
  },
  th: {
    title:              'โกะโมกุ',
    ...
    initialStatus:      'เลือกโหมดการเล่น',
    ...
    challenge:          'ท้า',
    vsAI:               'เล่นกับคอมพิวเตอร์',
    selectDifficulty:   'เลือกระดับความยาก',
    diffEasy:           'ง่าย',
    diffMedium:         'ปานกลาง',
    diffHard:           'ยาก',
    aiThinking:         'คอมพิวเตอร์กำลังคิด…',
    undoMove:           'ถอนหมาก',
  },
};
